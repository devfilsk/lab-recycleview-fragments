...
public class LinearHorizontalFragment extends Fragment {
    ...
    public LinearHorizontalFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public LinearHorizontalFragment(FloatingActionButton fab) {
        this.fab = fab;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view =  inflater.inflate(R.layout.fragment_linear_horizontal, container, false);
        mRecyclerView = view.findViewById(R.id.recycle_horizontal);
        setupRecycler();
