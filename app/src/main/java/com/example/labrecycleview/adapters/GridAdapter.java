...
public class GridAdapter extends RecyclerView.Adapter<GridAdapter.LineViewHolder>{

    private final List<UserModel> mUsers;

    public GridAdapter(ArrayList users) {
        this.mUsers = users;
    }
    ...
    public void onBindViewHolder(@NonNull LineViewHolder lineViewHolder, final int position) {
        ...
        lineViewHolder.text.setText(mUsers.get(position).getText());
    ...
    public class LineViewHolder extends RecyclerView.ViewHolder{
        ...
        public LineViewHolder(@NonNull View itemView) {
            ...
            moreButton = (ImageButton) itemView.findViewById(R.id.card_more);
            deleteButton = (ImageButton) itemView.findViewById(R.id.card_delete);
        }
    }
